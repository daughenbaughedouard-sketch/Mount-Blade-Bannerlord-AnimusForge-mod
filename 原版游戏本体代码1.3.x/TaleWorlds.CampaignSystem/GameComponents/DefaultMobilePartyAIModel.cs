...
namespace TaleWorlds.CampaignSystem.GameComponents
{
	...
	public class DefaultMobilePartyAIModel : MobilePartyAIModel
	{
		...
		// (get) Token: 0x060018B3 RID: 6323 RVA: 0x00077B2C File Offset: 0x00075D2C
		...
		// (get) Token: 0x060018B4 RID: 6324 RVA: 0x00077B33 File Offset: 0x00075D33
		...
		// (get) Token: 0x060018B5 RID: 6325 RVA: 0x00077B61 File Offset: 0x00075D61
		...
		// (get) Token: 0x060018B6 RID: 6326 RVA: 0x00077B6F File Offset: 0x00075D6F
		...
		// (get) Token: 0x060018B7 RID: 6327 RVA: 0x00077B76 File Offset: 0x00075D76
		...
		// (get) Token: 0x060018B8 RID: 6328 RVA: 0x00077B7D File Offset: 0x00075D7D
		...
		// Token: 0x060018B9 RID: 6329 RVA: 0x00077B84 File Offset: 0x00075D84
		public override bool ShouldConsiderAttacking(MobileParty party, MobileParty targetParty)
		{
			...
			bool flag4 = party.CurrentSettlement != null && party.CurrentSettlement.HasPort && party.HasNavalNavigationCapability;
			return flag && flag2 && (flag3 || flag4) && MobilePartyHelper.CanPartyAttackWithCurrentMorale(party);
		}

		// Token: 0x17000681 RID: 1665
		// (get) Token: 0x060018BA RID: 6330 RVA: 0x00077C07 File Offset: 0x00075E07
		...
		// (get) Token: 0x060018BB RID: 6331 RVA: 0x00077C15 File Offset: 0x00075E15
		...
		// (get) Token: 0x060018BC RID: 6332 RVA: 0x00077C1C File Offset: 0x00075E1C
		...
		// (get) Token: 0x060018BD RID: 6333 RVA: 0x00077C23 File Offset: 0x00075E23
		...
		// Token: 0x060018C0 RID: 6336 RVA: 0x00077D5C File Offset: 0x00075F5C
		...
		// Token: 0x060018C1 RID: 6337 RVA: 0x00077DD0 File Offset: 0x00075FD0
					...
					else
					{
						if (mobileParty2 != mobileParty && mobileParty2.IsActive && this.IsEnemy(mobileParty2.Party, mobileParty) && !mobileParty2.ShouldBeIgnored && (mobileParty2.CurrentSettlement == null || mobileParty2.IsGarrison || mobileParty2.IsLordParty))
						{
							...
							if (((currentSettlement != null) ? currentSettlement.SiegeEvent : null) == null && (!mobileParty2.IsGarrison || mobileParty.IsBandit) && (mobileParty2.BesiegerCamp == null || mobileParty2.BesiegerCamp.LeaderParty == mobileParty2) && (mobileParty2.Army == null || mobileParty2.Army.LeaderParty == mobileParty2 || mobileParty2.AttachedTo == null) && (mobileParty2.MapEvent == null || mobileParty2 == MobileParty.MainParty || mobileParty2.Party.MapEvent.MapEventSettlement != null || mobileParty2.Party == mobileParty2.Party.MapEvent.GetLeaderParty(BattleSideEnum.Attacker) || mobileParty2.Party == mobileParty2.Party.MapEvent.GetLeaderParty(BattleSideEnum.Defender)) && (mobileParty2.MapEvent == null || this.IsEnemy(mobileParty2.MapEvent.AttackerSide.LeaderParty, mobileParty) != this.IsEnemy(mobileParty2.MapEvent.DefenderSide.LeaderParty, mobileParty)) && (mobileParty2.CurrentSettlement == null || !mobileParty2.CurrentSettlement.IsHideout || !mobileParty.IsBandit))
							{
								...
								float num14;
								float num15;
								this.CalculateInitiativeScoresForEnemy(mobileParty, mobileParty2, out num14, out num15, num13, aggressiveness);
								if (flag)
								{
									num15 = 0f;
								}
		...
		// Token: 0x060018C2 RID: 6338 RVA: 0x00078F48 File Offset: 0x00077148
		...
		// Token: 0x060018C3 RID: 6339 RVA: 0x00078F5C File Offset: 0x0007715C
		...
		// Token: 0x060018C4 RID: 6340 RVA: 0x00079520 File Offset: 0x00077720
		...
		// Token: 0x060018C5 RID: 6341 RVA: 0x00079739 File Offset: 0x00077939
