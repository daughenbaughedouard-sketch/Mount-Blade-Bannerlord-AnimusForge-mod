...
namespace Iced.Intel.DecoderInternal
{
	...
	internal sealed class LegacyOpCodeHandlerReader : OpCodeHandlerReader
	{
		...
		{
			ref OpCodeHandler elem = ref result[resultIndex];
			...
			case LegacyOpCodeHandlerKind.AnotherTable:
				elem = new OpCodeHandler_AnotherTable(deserializer.ReadArrayReference(8U));
				return 1;
			case LegacyOpCodeHandlerKind.Group:
				elem = new OpCodeHandler_Group(deserializer.ReadArrayReference(8U));
				return 1;
			case LegacyOpCodeHandlerKind.Group8x64:
				elem = new OpCodeHandler_Group8x64(deserializer.ReadArrayReference(8U), deserializer.ReadArrayReference(8U));
				return 1;
			case LegacyOpCodeHandlerKind.Group8x8:
				elem = new OpCodeHandler_Group8x8(deserializer.ReadArrayReference(8U), deserializer.ReadArrayReference(8U));
				return 1;
