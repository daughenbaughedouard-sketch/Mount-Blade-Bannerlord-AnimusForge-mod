		...
		foreach (string text in array)
		{
			try
			{
				...
				try
				{
					...
					ConstructorInfo[] array3 = array2;
					foreach (ConstructorInfo original in array3)
					{
						try
						{
				...
				string[] array4 = new string[3] { "OnConversationContinue", "ExecuteContinue", "RefreshValues" };
