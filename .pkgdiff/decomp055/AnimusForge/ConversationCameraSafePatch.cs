...
public static class ConversationCameraSafePatch
{
	...
	public static bool Prefix()
	{
		try
		{
			...
			if ((NativeObject)(object)current.Scene == (NativeObject)null || current.Agents == null)
			{
				return false;
			}
			Campaign current2 = Campaign.Current;
			ConversationManager val = ((current2 != null) ? current2.ConversationManager : null);
			if (val == null || val.OneToOneConversationAgent == null)
			{
				return false;
			}
		}
