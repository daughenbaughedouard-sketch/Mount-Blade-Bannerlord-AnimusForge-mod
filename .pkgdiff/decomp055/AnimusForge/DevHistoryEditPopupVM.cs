...
public class DevHistoryEditPopupVM : ViewModel
{
	...
	public string OriginalContentText
	{
		...
		set
		{
			if (value != _originalContentText)
			{
				...
				((ViewModel)this).OnPropertyChangedWithValue<string>(value, "OriginalContentText");
			}
		}
	}
	...
	public string InputHintText
	{
		...
		set
		{
			if (value != _inputHintText)
			{
				...
				((ViewModel)this).OnPropertyChangedWithValue<string>(value, "InputHintText");
			}
		}
	}
	...
	public string EditedText
	{
		...
		set
		{
			...
			{
				_editedText = value;
				((ViewModel)this).OnPropertyChangedWithValue<string>(value, "EditedText");
			}
		}
	}
	...
	public string SaveText
	{
		...
		set
		{
			...
			{
				_saveText = value;
				((ViewModel)this).OnPropertyChangedWithValue<string>(value, "SaveText");
			}
		}
	}
