...
public class CharacterDeveloperHeroItemVM : ViewModel
{
	...
	public void RefreshCharacterValues()
	{
		...
		CurrentTotalSkill = HeroDeveloper.TotalXp;
		SkillPointsRequiredForNextLevel = Campaign.Current.Models.CharacterDevelopmentModel.GetXpRequiredForSkillLevel(Hero.CharacterObject.Level + 1);
