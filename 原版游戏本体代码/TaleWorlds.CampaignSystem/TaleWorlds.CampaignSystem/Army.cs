...
public class Army : ITrackableCampaignObject, ITrackableBase
{
	...
	{
		if (IsArmyInGatheringState && AiBehaviorObject is Settlement settlement && settlement == siegeEvent.BesiegedSettlement && LeaderParty.SiegeEvent == null && LeaderParty.MapEvent == null)
		{
	...
	{
		if (IsArmyInGatheringState && AiBehaviorObject is Settlement settlement2 && settlement2 == settlement && settlement.MapFaction != LeaderParty.MapFaction && LeaderParty.SiegeEvent == null && LeaderParty.MapEvent == null)
		{
			FindBestGatheringSettlementAndMoveTheLeader(settlement);
		}
	}
	...
	{
		if (AiBehaviorObject != null && LeaderParty.SiegeEvent == null && LeaderParty.MapEvent == null && LeaderParty.ShortTermBehavior == AiBehavior.Hold && IsArmyInGatheringState)
		{
