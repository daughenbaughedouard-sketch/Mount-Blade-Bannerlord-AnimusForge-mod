...
namespace TaleWorlds.CampaignSystem
{
	...
	{
		// Token: 0x0600133B RID: 4923 RVA: 0x000570BA File Offset: 0x000552BA
		public SaveableCampaignTypeDefiner()
			: base(330000)
		{
		}

		// Token: 0x0600133C RID: 4924 RVA: 0x000570C8 File Offset: 0x000552C8
		protected override void DefineClassTypes()
		{
			...
			base.AddClassDefinition(typeof(Ship), 316, null);
			base.AddClassDefinition(typeof(AnchorPoint), 319, null);
			base.AddClassDefinition(typeof(Incident), 322, null);
			base.AddClassDefinition(typeof(BlockadeBattleMapEvent), 325, null);
			base.AddClassDefinition(typeof(Figurehead), 326, null);
			base.AddClassDefinition(typeof(MobilePartyAi.FleeingData), 327, null);
			base.AddClassDefinition(typeof(MapMarker), 328, null);
			base.AddClassDefinition(typeof(MapMarkerManager), 329, null);
			base.AddClassDefinition(typeof(PatrolPartyComponent), 330, null);
			base.AddClassDefinition(typeof(TradeAgreementDecision), 331, null);
			base.AddClassDefinition(typeof(TradeAgreementDecision.TradeAgreementDecisionOutcome), 332, null);
			base.AddClassDefinition(typeof(TradeAgreementLogEntry), 333, null);
			base.AddClassDefinition(typeof(StartAllianceDecision), 334, null);
			base.AddClassDefinition(typeof(ProposeCallToWarAgreementDecision), 335, null);
			base.AddClassDefinition(typeof(StartAllianceLogEntry), 336, null);
			base.AddClassDefinition(typeof(EndAllianceLogEntry), 337, null);
			base.AddClassDefinition(typeof(StartCallToWarAgreementLogEntry), 338, null);
			base.AddClassDefinition(typeof(EndCallToWarAgreementLogEntry), 339, null);
			base.AddClassDefinition(typeof(AcceptCallToWarAgreementDecision), 340, null);
			base.AddClassDefinition(typeof(AllianceOfferMapNotification), 341, null);
			base.AddClassDefinition(typeof(ProposeCallToWarOfferMapNotification), 342, null);
			base.AddClassDefinition(typeof(AcceptCallToWarOfferMapNotification), 343, null);
			base.AddClassDefinition(typeof(TributeFinishedMapNotification), 344, null);
		}

		// Token: 0x0600133D RID: 4925 RVA: 0x00058470 File Offset: 0x00056670
		protected override void DefineStructTypes()
		{
			...
			base.AddStructDefinition(typeof(CampaignVec2), 1022, null);
		}

		// Token: 0x0600133E RID: 4926 RVA: 0x00058518 File Offset: 0x00056718
		protected override void DefineEnumTypes()
		{
			...
			base.AddEnumDefinition(typeof(Army.ArmyDispersionReason), 2023, new ArmyDispersionReasonEnumResolver());
			...
			base.AddEnumDefinition(typeof(MobileParty.NavigationType), 2150, null);
			base.AddEnumDefinition(typeof(GameAccelerationMode), 2160, null);
		}

		// Token: 0x0600133F RID: 4927 RVA: 0x00058980 File Offset: 0x00056B80
		protected override void DefineInterfaceTypes()
		{
			...
			base.AddInterfaceDefinition(typeof(ITrackableBase), 3006);
			base.AddInterfaceDefinition(typeof(ICustomSystemManager), 3007);
		}

		// Token: 0x06001340 RID: 4928 RVA: 0x00058A20 File Offset: 0x00056C20
		protected override void DefineGenericClassDefinitions()
		{
			...
			base.ConstructGenericClassDefinition(typeof(PropertyOwner<PerkObject>));
			base.ConstructGenericClassDefinition(typeof(PropertyOwner<TraitObject>));
			base.ConstructGenericClassDefinition(typeof(PropertyOwner<PropertyObject>));
		}

		// Token: 0x06001341 RID: 4929 RVA: 0x00058B10 File Offset: 0x00056D10
		protected override void DefineConflictResolvers()
		{
			base.AddConflictResolver(26, new CharacterPerksResolver());
			base.AddConflictResolver(27, new CharacterTraitsResolver());
			base.AddConflictResolver(288, new CharacterAttributesResolver());
			base.AddConflictResolver(28, new HeroTraitDeveloperResolver());
			base.AddConflictResolver(29, new HeroDeveloperResolver());
		}

		// Token: 0x06001342 RID: 4930 RVA: 0x00058B64 File Offset: 0x00056D64
		protected override void DefineGenericStructDefinitions()
		{
			...
			base.ConstructGenericStructDefinition(typeof(ValueTuple<Kingdom, Kingdom>));
		...
		// Token: 0x06001343 RID: 4931 RVA: 0x00058BE4 File Offset: 0x00056DE4
		protected override void DefineContainerDefinitions()
		{
			...
			base.ConstructContainerDefinition(typeof(List<Ship>));
			base.ConstructContainerDefinition(typeof(List<Figurehead>));
			base.ConstructContainerDefinition(typeof(List<MapMarker>));
			...
			base.ConstructContainerDefinition(typeof(Dictionary<Settlement, bool>));
			...
			base.ConstructContainerDefinition(typeof(Dictionary<Hero, Hero>));
			base.ConstructContainerDefinition(typeof(Dictionary<ITrackableBase, TrackedObject>));
			base.ConstructContainerDefinition(typeof(List<Ship>));
			base.ConstructContainerDefinition(typeof(Dictionary<Incident, CampaignTime>));
			base.ConstructContainerDefinition(typeof(Dictionary<MobileParty, CampaignVec2>));
			base.ConstructContainerDefinition(typeof(Dictionary<Hero, Figurehead>));
			base.ConstructContainerDefinition(typeof(Dictionary<MobileParty, Dictionary<MobileParty, CampaignTime>>));
			base.ConstructContainerDefinition(typeof(Dictionary<MobileParty, Dictionary<Settlement, CampaignTime>>));
			base.ConstructContainerDefinition(typeof(Dictionary<MobileParty, Settlement>));
			base.ConstructContainerDefinition(typeof(Dictionary<MapEvent, MobileParty>));
			base.ConstructContainerDefinition(typeof(List<ICustomSystemManager>));
			base.ConstructContainerDefinition(typeof(Dictionary<Settlement, MobileParty>));
		}
	}
}
