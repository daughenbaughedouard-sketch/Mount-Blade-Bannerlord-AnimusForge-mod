...
public static class PartyScreenHelper
{
	...
	public static PartyState GetActivePartyState()
	{
		...
		Debug.FailedAssert("GetActivePartyState requested but the active state is not PartyState!", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "GetActivePartyState", 7350);
		return null;
	}
	...
	private static void ClosePartyPresentation(bool isForced, bool fromCancel)
	{
		...
		{
			Debug.FailedAssert("Trying to close party screen when it's already closed!", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "ClosePartyPresentation", 7417);
			return;
		}
		bool flag = true;
		if (!fromCancel)
