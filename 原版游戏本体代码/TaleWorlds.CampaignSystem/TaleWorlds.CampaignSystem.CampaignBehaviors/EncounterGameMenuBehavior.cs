...
public class EncounterGameMenuBehavior : CampaignBehaviorBase
{
	...
	private void naval_town_outside_on_init(MenuCallbackArgs args)
	{
		...
		{
			Debug.FailedAssert("naval_town_outside_on_init", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\EncounterGameMenuBehavior.cs", "naval_town_outside_on_init", 982);
			PlayerEncounter.Finish();
		}
	...
	private void game_menu_join_siege_event_on_consequence(MenuCallbackArgs args)
	{
		...
		{
			Debug.FailedAssert("Player should not be able to join this siege.", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\EncounterGameMenuBehavior.cs", "game_menu_join_siege_event_on_consequence", 1093);
		}
	}
	...
	private void UpdateVillageHostileActionEncounter(MenuCallbackArgs args)
	{
		...
		{
			Debug.FailedAssert("This case should not be happening anymore, check this case and make sure this is intended", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\EncounterGameMenuBehavior.cs", "UpdateVillageHostileActionEncounter", 1611);
		}
	}
	...
	private void game_menu_town_menu_request_meeting_with_besiegers_on_init(MenuCallbackArgs args)
	{
		...
		if (currentSettlement.SiegeEvent == null)
		{
			...
			Debug.FailedAssert("non-fortification under siege", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\EncounterGameMenuBehavior.cs", "game_menu_town_menu_request_meeting_with_besiegers_on_init", 3006);
		}
