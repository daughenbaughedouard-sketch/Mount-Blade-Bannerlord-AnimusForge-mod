...
public class PlayerTownVisitCampaignBehavior : CampaignBehaviorBase
{
	...
	private static void game_menu_town_go_to_keep_on_consequence(MenuCallbackArgs args)
	{
		...
		Debug.FailedAssert("invalid LimitedAccessSolution or AccessLevel for town keep", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\PlayerTownVisitCampaignBehavior.cs", "game_menu_town_go_to_keep_on_consequence", 465);
	}
	...
	private static void SetLordsHallAccessLimitationReasonText(MenuCallbackArgs args, SettlementAccessModel.AccessDetails accessDetails)
	{
		...
		case SettlementAccessModel.AccessLimitationReason.LocationEmpty:
			...
			break;
		default:
			Debug.FailedAssert($"{accessDetails.AccessLimitationReason} is not a valid no access reason for lord's hall", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\PlayerTownVisitCampaignBehavior.cs", "SetLordsHallAccessLimitationReasonText", 714);
			break;
		}
	}
	...
	private static void UpdateMenuLocations(string menuID)
	{
		...
		case "castle_dungeon":
			...
			break;
		default:
			Debug.FailedAssert("Could not get the associated locations for Game Menu: " + menuID, "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\PlayerTownVisitCampaignBehavior.cs", "UpdateMenuLocations", 853);
			Campaign.Current.GameMenuManager.MenuLocations.AddRange(settlement.LocationComplex.GetListOfLocations());
			break;
	...
	private static void SetIntroductionText(Settlement settlement, bool fromKeep)
	{
		...
		{
			Debug.FailedAssert("Couldn't set settlementIntro!", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\CampaignBehaviors\\PlayerTownVisitCampaignBehavior.cs", "SetIntroductionText", 1377);
