...
public class CompanionRolesCampaignBehavior : CampaignBehaviorBase
{
	...
	private static bool companion_assign_but_too_many_role_on_condition()
	{
		if (Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero.Clan == Clan.PlayerClan && Hero.OneToOneConversationHero.PartyBelongedTo == MobileParty.MainParty)
		{
			return MobileParty.MainParty.GetHeroPartyRoles(Hero.OneToOneConversationHero).Count >= Campaign.Current.Models.ClanMemberPartyRoleModel.MaximumPartyRoleAssignmentCount;
	...
	private static bool party_role_assignment_clickable_condition(PartyRole role, out TextObject explanation)
	{
	...
	private static bool companion_becomes_engineer_clickable_condition(out TextObject explanation)
	{
	...
	private static bool companion_becomes_surgeon_clickable_condition(out TextObject explanation)
	{
	...
	private static bool companion_becomes_quartermaster_clickable_condition(out TextObject explanation)
	{
	...
	private static bool companion_becomes_scout_clickable_condition(out TextObject explanation)
	{
	...
	private static bool CanFireHeroFromRole(PartyRole role, Hero hero)
	{
