...
public class PlayerEncounter
{
			...
			if (joinBattle)
			{
				if (MobileParty.MainParty.MapEvent == null)
				{
					if (defenderParty.MapEvent != null)
					{
						...
						{
							Debug.FailedAssert("false", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "Init", 521);
						}
					}
					else
					{
						Debug.FailedAssert("If there is no map event we should create one in order to join battle", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "Init", 526);
					}
				}
	...
	private MapEvent StartBattleInternal()
	{
		if (_mapEvent == null)
		{
			...
			else if (_defenderParty.IsSettlement)
			{
				...
				{
					Debug.FailedAssert("Proper mapEvent type could not be set for the battle.", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "StartBattleInternal", 757);
				}
			}
		...
		while (!_stateHandled)
		{
			...
			if (!_stateHandled)
			{
				...
				case PlayerEncounterState.End:
					...
					break;
				default:
					Debug.FailedAssert("[DEBUG]Invalid map event state: " + _mapEventState, "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "UpdateInternal", 1063);
					break;
				}
			}
		}
	...
	private void ContinueBattle()
	{
		...
		{
			Debug.FailedAssert("This case should not be called anymore, make sure this is intended", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "ContinueBattle", 1205);
		...
		{
			Debug.FailedAssert("This case should not be called anymore, make sure this is intended", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "ContinueBattle", 1214);
	...
	public void FinalizeBattle()
	{
		if (_mapEvent != null)
		{
			if (_mapEvent.HasWinner || _mapEvent.DiplomaticallyFinished || _mapEvent.IsSiegeAmbush || (_mapEvent.IsRaid && (_mapEvent.MapEventSettlement.SettlementHitPoints.ApproximatelyEqualsTo(0f) || _mapEvent.PartiesOnSide(_mapEvent.PlayerSide).Any((MapEventParty x) => x.Party.MobileParty != null && !x.Party.MobileParty.IsMainParty))))
			{
	...
	public static void StartSiegeAmbushMission()
	{
		...
		case Settlement.SiegeState.Invalid:
			Debug.FailedAssert("Siege state is invalid!", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "StartSiegeAmbushMission", 2187);
			break;
		}
	}
