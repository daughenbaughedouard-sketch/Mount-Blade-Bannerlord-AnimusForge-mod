...
public class MissionScoreboardPlayerSortControllerVM : ViewModel
{
	...
	public class ItemKillComparer : ItemComparerBase
	{
		public override int Compare(MissionScoreboardPlayerVM x, MissionScoreboardPlayerVM y)
		{
			MissionScoreboardStatItemVM missionScoreboardStatItemVM = ((IEnumerable<MissionScoreboardStatItemVM>)x.Stats).FirstOrDefault((MissionScoreboardStatItemVM s) => s.HeaderID == "kill");
			MissionScoreboardStatItemVM missionScoreboardStatItemVM2 = ((IEnumerable<MissionScoreboardStatItemVM>)y.Stats).FirstOrDefault((MissionScoreboardStatItemVM s) => s.HeaderID == "kill");
	...
	public class ItemAssistComparer : ItemComparerBase
	{
		public override int Compare(MissionScoreboardPlayerVM x, MissionScoreboardPlayerVM y)
		{
			MissionScoreboardStatItemVM missionScoreboardStatItemVM = ((IEnumerable<MissionScoreboardStatItemVM>)x.Stats).FirstOrDefault((MissionScoreboardStatItemVM s) => s.HeaderID == "assist");
			MissionScoreboardStatItemVM missionScoreboardStatItemVM2 = ((IEnumerable<MissionScoreboardStatItemVM>)y.Stats).FirstOrDefault((MissionScoreboardStatItemVM s) => s.HeaderID == "assist");
			if (missionScoreboardStatItemVM != null && missionScoreboardStatItemVM2 != null)
			{
				return int.Parse(missionScoreboardStatItemVM2.Item).CompareTo(int.Parse(missionScoreboardStatItemVM.Item)) * ((!_isAscending) ? 1 : (-1));
			}
	...
	public string KillText
	{
		...
		set
		{
			...
			{
				_killText = value;
				((ViewModel)this).OnPropertyChangedWithValue<string>(value, "KillText");
			}
		}
	}
	...
	public string AssistText
	{
		...
		set
		{
			...
			{
				_assistText = value;
				((ViewModel)this).OnPropertyChangedWithValue<string>(value, "AssistText");
			}
		}
	}
	...
	public int ScoreState
	{
		...
		set
		{
			...
			{
				_scoreState = value;
				((ViewModel)this).OnPropertyChangedWithValue(value, "ScoreState");
			}
		}
	}
	...
	public int KillState
	{
		...
		set
		{
			...
			{
				_killState = value;
				((ViewModel)this).OnPropertyChangedWithValue(value, "KillState");
			}
		}
	}
	...
	public int AssistState
	{
		...
		set
		{
			...
			{
				_assistState = value;
				((ViewModel)this).OnPropertyChangedWithValue(value, "AssistState");
			}
		}
	}
	...
	public bool IsScoreSelected
	{
		...
		set
		{
			if (value != _isScoreSelected)
			{
				...
				((ViewModel)this).OnPropertyChangedWithValue(value, "IsScoreSelected");
			}
		}
	}
	...
	public bool IsKillSelected
	{
		...
		set
		{
			if (value != _isKillSelected)
			{
				...
				((ViewModel)this).OnPropertyChangedWithValue(value, "IsKillSelected");
			}
		}
	}
	...
	public bool IsAssistSelected
	{
		...
		set
		{
			if (value != _isAssistSelected)
			{
				...
				((ViewModel)this).OnPropertyChangedWithValue(value, "IsAssistSelected");
			}
		}
	}
	...
	{
		NameText = ((object)GameTexts.FindText("str_scoreboard_header", "name")).ToString();
		ScoreText = ((object)GameTexts.FindText("str_scoreboard_header", "score")).ToString();
		KillText = ((object)GameTexts.FindText("str_scoreboard_header", "kill")).ToString();
		AssistText = ((object)GameTexts.FindText("str_scoreboard_header", "assist")).ToString();
	}
	...
	public void SortByCurrentState()
	{
		if (IsNameSelected)
		{
			_listToControl.Sort((IComparer<MissionScoreboardPlayerVM>)_nameComparer);
		}
		else if (IsScoreSelected)
		{
			_listToControl.Sort((IComparer<MissionScoreboardPlayerVM>)_scoreComparer);
		}
		else if (IsKillSelected)
		{
			_listToControl.Sort((IComparer<MissionScoreboardPlayerVM>)_killComparer);
		}
		else if (IsAssistSelected)
		{
			_listToControl.Sort((IComparer<MissionScoreboardPlayerVM>)_assistComparer);
		}
	}
